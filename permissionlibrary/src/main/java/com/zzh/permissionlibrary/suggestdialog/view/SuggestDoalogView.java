package com.zzh.permissionlibrary.suggestdialog.view;
...
public class SuggestDoalogView extends FrameLayout {
    ...
    public SuggestDoalogView(Context context) {
        this(context, null);
    }

    public SuggestDoalogView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SuggestDoalogView(Context context, AttributeSet attrs, int defStyleAttr) {
